...
class DiggerGui @JvmOverloads constructor(application: App, parent: Gui? = null, ticksExisted: Double = 0.0) : Gui(application, parent, ticksExisted) {
    ...
    override fun init() {
        ...
        example1Shader[GL20C.GL_VERTEX_SHADER] = "resources/example/shaders/example1.vert"
        example1Shader[GL20C.GL_FRAGMENT_SHADER] = "resources/example/shaders/example1.frag"
